  ...
  return <section id="feature-3" className="relative sm:w-[1242px] mx-auto mt-[200px] sm:mt-[345px]">
    <div className="flex flex-col items-center">
      ...
      <div className="mt-[50px] sm:mt-[115px] w-full flex flex-col sm:flex-row items-center gap-6">
        <Card type="aurora" border="bold" className="w-[95%] sm:w-[1200px]" height="h-[350px] sm:h-[500px]">
          <img src="/feature-view-custom-1.png" alt="Custom view" className="absolute w-[300px] sm:w-[778px] top-[27px] left-[36px]" />
          <img src="/feature-view-custom-2.png" alt="Custom view" className="absolute w-[180px] sm:w-[493px] top-[100px] left-[180px] sm:left-[600px]" />
          <CardTitle
