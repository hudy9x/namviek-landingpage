...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className=" relative rounded-full border border-white/[0.2] bg-black shadow-input flex justify-center space-x-4 px-8 py-4"
    >
      {children}
    </nav>
  );
...
export const SimpleLink = ({ children, ...rest }: any) => {
  return (
